...
| `/shva:mdp-architect [brief-or-artifact]` | Builds or audits a coherent MDP or book-shaped executive programme. It uses an approved Book Foundation Record, then protects the scene-to-concept, concept-to-framework, and chapter-to-exercise hinges across Book, Teaching, Slides, workbook, realistic filled edition, sources, pacing, and interactive HTML. | **When two or more teaching surfaces must work as one programme.** New MDPs, deep chapter development, or an existing course that feels thin, abrupt, busy, generic, disconnected, or under-timed. |
...
>
> **Book and chapter integrity (v0.12.0):** For a new book or substantial book-shaped reframe, `mdp-architect` first returns an approved Book Foundation Record. It then keeps concepts earned, evidence mechanisms distinct, visuals scarce, and the chapter-end exercise causally connected, input-gated, and field-for-field comparable with its filled edition.
>
