...
>
> **Book foundation (v0.11.0):** For a new book or substantial book-shaped reframe, `mdp-architect` first returns an approved Book Foundation Record. It offers title and cover systems in chat, separates an Author's Note from real acknowledgements, and waits for editorial approval before HTML or cover production.
>
