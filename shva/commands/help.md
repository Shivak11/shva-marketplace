...
| `/shva:mdp-architect [brief-or-artifact]` | Builds or audits a coherent multi-session programme. It establishes or reuses an approved Programme Thesis Record, audits inherited material by present function, and then protects the learning progression and cross-surface hinges. Book-shaped work also uses a separate Book Foundation Record; workshops and courses do not inherit book-identity questions. | **When programme architecture or two or more teaching surfaces must work as one system.** New programmes, substantial syllabus redesigns, deep chapter development, or an existing course that feels thin, abrupt, generic, disconnected, or under-timed. |
...
| `/shva:book-taste-curator [topic-or-title]` | Judges prospective books against the codified taste profile: structural rigor, mechanism-led examples, serious credentials, and a hard ban on keynote-circuit writing. Four modes: Discovery, Verdict, Extraction, and Rebuttal. | **Before spending a month on a book.** Deciding what to read, whether a hyped title is worth it, or mining a finished book for prompt moves. |
...
>
> **Programme thesis and transformation audit (v0.14.0):** `mdp-architect` begins substantial programme work by establishing the recognised problem, promised learner change, central question, distinctive argument, evidence boundary, carried proof, and capability progression. Existing material is preserved, reframed, combined, resequenced, added, or omitted by present function. Book-shaped work separately settles reader, voice, front matter, title, and visual identity; non-book work is never forced through that gate.
>
