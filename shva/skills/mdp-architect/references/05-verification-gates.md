...
- Walk the exercise from first decision through any consequence reveal, immediate human revision, AI challenge, executable action, filled-edition reveal, and transfer. Confirm the AI role is composed from allow-listed questioning or stress-testing moves and explicitly denies approval, denial, certification, decision, and authorisation authority; reject a parallel free-text role that could contradict the structured boundary. Reject a reveal that changes no subsequent decision, a form that demands every field before the first consequential fact appears, or an AI challenge that arrives before the learner has responded to changed information.
